...
**程序先从主线程开始执行（main为主线程入口）。当遇到star()方法时，开启多线程模式。此时子线程与主线程交替执行。如果在主线程方法后开启线程，则要等主线程先执行完再执行主线程后面的子线程。（具体查看 九 ）**
...
![image-20201008190144639](https://gitee.com/zelen/IMG/raw/master/PicGo/image-20201008190144639.png)
