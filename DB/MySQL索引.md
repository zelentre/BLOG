...
![](https://testingcf.jsdelivr.net/gh/znej/pic/picgo/2021013023233065.png)
...
![](https://testingcf.jsdelivr.net/gh/znej/pic/picgo/20210130232533425.png)
...
![](https://testingcf.jsdelivr.net/gh/znej/pic/picgo/20220308214810.png)
...
![存储引擎是基于表的，以下建立两张别使用MyISAM和InnoDB引擎的表，看看其在文件系统中对应的文件存储格式。](https://testingcf.jsdelivr.net/gh/znej/pic/picgo/20210130233352294.png)
